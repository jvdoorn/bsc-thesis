...
\begin{figure}[ht!]
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\subcaption{Overview of the fine structures. On the left we see the junction loop and on the right the dc-SQUID. The view has been rotated \qty{90}{\degree} clockwise compared to the other figures for visual clarity.}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
